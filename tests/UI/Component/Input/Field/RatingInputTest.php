...
class RatingInputTest extends ILIAS_UI_TestBase
{
    ...
    public function testRatingRenderBasic(): void
    {
        ...
        $expected = $this->brutallyTrimHTML('
            <div class="form-group row"><label for="id_1" class="control-label col-sm-4 col-md-3 col-lg-2">label</label><div class="col-sm-8 col-md-9 col-lg-10">
        ...
        $html = $this->brutallyTrimHTML($r->render($rating));

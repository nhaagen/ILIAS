...
class Factory implements I\Container\Factory
{
     ...
     * @inheritdoc
     */
    public function wizard() : I\Container\Wizard\Factory
    {
        return $this->wizard_factory;
    }
}

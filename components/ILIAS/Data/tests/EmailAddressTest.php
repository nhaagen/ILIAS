...
{
    #[DataProvider('validEmailProvider')] public function testEmailObjectConstruction(
        string $input,
    ...
    #[DataProvider('invalidEmailProvider')] public function testEmailThrows(
        string $input,
    ): void {
    ...
    #[DataProvider('invalidEmailDomainProvider')] public function testEmailDomainThrows(
        string $input,
    ): void {
        $this->expectException(InvalidArgumentException::class);
        new EmailAddress($input);
    ...
    #[DataProvider('invalidEmailLocalProvider')] public function testEmailLocalThrows(
        string $input,
    ): void {
        $this->expectException(InvalidArgumentException::class);
        new EmailAddress($input);
    ...
    #[DataProvider('validAsciiEmailProvider')] public function testAsciiEmailFlags(
        string $input,
    ): void {
    ...
    #[DataProvider('validUnicodeEmailProvider')] public function testAsciiEmailFlagsWhenUnicode(
        string $input,
    ): void {
        $address = new EmailAddress($input);

...
return array(
  ...
  array(
    ...
    array(
      ...
      7 => 'ModalDialogDialog',
      8 => 'ModalDialogResponseDialogResponse',
    ),
    'less_variables' =>
    array(
    ),
  ...
  array(
    ...
    'examples' =>
    array(
      'base' => 'components/ILIAS/UI/src/examples/Legacy/base.php',
      'inside_panel' => 'components/ILIAS/UI/src/examples/Legacy/inside_panel.php',
    ),
  ),
  'TableFactoryTable' =>
  array(
  ...
  array(
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/ColorPicker',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\ColorPicker',
    'examples' =>
    array(
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/ColorPicker/base.php',
    ),
  ),
...
Cells and its content are responsively adapted if the size of the screen is changed.',
  ...
  array(
    ...
    array(
      ...
      'with_all_view_controls' => 'components/ILIAS/UI/src/examples/Panel/Standard/with_all_view_controls.php',
  ...
  array(
    ...
    array(
      ...
      'with_list_actions' => 'components/ILIAS/UI/src/examples/Panel/Listing/Standard/with_list_actions.php',
    ),
  ),
  ...
  array(
    ...
    array(
      ...
      'with_viewcontrollers' => 'components/ILIAS/UI/src/examples/Panel/Secondary/Listing/with_viewcontrollers.php',
    ),
  ),
  ...
  array(
    ...
    array(
      ...
      'with_viewcontrollers' => 'components/ILIAS/UI/src/examples/Panel/Secondary/Legacy/with_viewcontrollers.php',
    ),
  ),
  ...
  array(
    ...
    'description' =>
    array(
      'purpose' => 'A Modal interrupts a user to focus on a certain task or/and prompts for information without the user losing the current context. The Dialog Modal is async by default and merely provides a wrapper, its contents are defined by the Modal Response.',
      'composition' => 'The Dialog Modal uses the HTML dialog tag.',
      'effect' => 'The contents of Dialog Modal are loaded asynchronously by default; actions of Forms and targets of Links are "wrapped" to RPCs and thus stay in context of the Dialog, i.e. you may take roundtrips to the server and modify the Dialog\'s content without closing it.',
      'rivals' =>
      array(
      ),
    ),
    ...
    'context' =>
    array(
      0 => 'The Dialog Modal requires a Dialog Response.',
    ),
    'selector' => '',
    'feature_wiki_references' =>
    array(
    ...
    array(
      'usage' =>
      array(
        1 => 'The server MUST answer with a DialogResponse Component to a request to the url provided to the Dialog.',
      ),
      'composition' =>
      array(
      ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Modal/Dialog',
    'namespace' => '\\ILIAS\\UI\\Component\\Modal\\Dialog',
    'examples_path' => 'components/ILIAS/UI/src/examples/Modal/Dialog',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Modal\\Dialog',
    'examples' =>
    array(
      'base' => 'components/ILIAS/UI/src/examples/Modal/Dialog/base.php',
      'form' => 'components/ILIAS/UI/src/examples/Modal/Dialog/form.php',
      'parameters' => 'components/ILIAS/UI/src/examples/Modal/Dialog/parameters.php',
    ),
  ),
  'ModalDialogResponseDialogResponse' =>
  array(
    'id' => 'ModalDialogResponseDialogResponse',
    ...
    'description' =>
    array(
      'purpose' => 'A Dialog Response serves as a formalized wrapper around output of asynchrounous requests in order to provide contents for a Dialog. It allows for dedicated changes to recurring parts of Dialogs, such as Title, Content or Buttons.',
      'composition' => 'The Dialog Response accepts Dialog Content to be handled by the Dialog Modal.',
      'effect' => 'The sections of the Dialog Response are rendered to their respective parts of the Dialog Modal. Forms and Links are automatically turned into async requests to stay in context of the Dialog. You may also tell the Dialog to close - after the request has been processed.',
      'rivals' =>
      array(
      ),
    ),
    ...
    'context' =>
    array(
      0 => 'The Dialog Response is used for Dialog Modals.',
    ),
    'selector' => '',
    'feature_wiki_references' =>
    array(
    ...
    'path' => 'components/ILIAS/UI/src/Component/Modal/DialogResponse',
    'namespace' => '\\ILIAS\\UI\\Component\\Modal\\DialogResponse',
    'examples_path' => 'components/ILIAS/UI/src/examples/Modal/DialogResponse',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Modal\\DialogResponse',
    'examples' =>
    array(
    ),
  ),
  ...
  array(
    ...
    'examples' =>
    array(
      'footer' => 'components/ILIAS/UI/src/examples/MainControls/Footer/footer.php',
      'footer_with_modals' => 'components/ILIAS/UI/src/examples/MainControls/Footer/footer_with_modals.php',
    ),
  ),

        ...
        $expected_html = <<<EOT
            <div class="c-sequence c-sequence--linear">
                ...
                <div class="c-sequence__header">
                    <div class="c-sequence__header__global">
                        <div class="l-bar__space-keeper">
                            <nav id="id_3" class="l-bar__group" aria-label="ui_nav_sequence_control_label" aria-describedby="id_4" aria-controls="id_1">
                                <p id="id_4" class="sr-only">ui_nav_sequence_description</p>
                                <div class="l-bar__element c-sequence__navigation--back"> {$this->button_html}</div>
                                <div class="l-bar__element c-sequence__navigation--next"> {$this->button_html}</div>
                            </nav>
                ...
                <div id="id_1" class="c-sequence__segment" role="region" aria-describedby="id_2"> content</div>
            </div>
        EOT;

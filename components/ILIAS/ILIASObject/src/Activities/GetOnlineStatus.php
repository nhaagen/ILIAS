...
class GetOnlineStatus extends \ILIAS\Component\Activities\Query implements ObjectActivity
{
    ...
    public function getDescription(): Text\SimpleDocumentMarkdown
    {
        ...
        return $this->data_factory->text()->markdown()->simpleDocument('
            This gets the online status for an ILIAS Object.
        ');
    }

    public function getInputDescription(): FormInput
    {
        return $this->ui_factory->input()->field()->numeric(
            'obj_id'
        );
    }

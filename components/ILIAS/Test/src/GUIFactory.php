...
class GUIFactory
{
    ...
    public function __construct(
        ...
        $this->definitions['ConsecutiveScoringGUI'] = $this->definitions['ILIAS\Test\Scoring\Manual\ConsecutiveScoringGUI'];
        ...
        $this->internal['manscoring.testscoring'] = fn(\ilObjTest $test_obj): TestScoring =>
                new TestScoring(
                    ...
                    //$this->test_dic['results.data.test_result_repository']
                    $this->global_dic['lng'],
                );
